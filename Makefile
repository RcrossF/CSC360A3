.phony all:
all: diskinfo disklist diskget diskput diskstick
...
diskstick: diskstick.c
	gcc -Wall diskstick.c -o diskstick -g

.PHONY clean:
clean:
	-rm -rf *.o diskget diskput diskinfo disklist diskstick
